...
const MessageBar = () => {
  ...
  return (
    <div className="h-[10vh] bg-[#1c1d25] flex justify-center items-center px-8 gap-6 mb-5">
      ...
      <button
        className="bg-[#A9B0B3] rounded-md flex items-center justify-center p-5 gap-2 focus:border-none focus:outline-none hover:bg-[#484A4C] focus:bg-[#484A4C] transition-all duration-300 "
