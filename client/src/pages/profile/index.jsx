...
const Profile = () => {
  ...
  return (
    ...
    >
      <div className=" w-[80vw] md:w-max flex flex-col gap-10 bg-[#283237] bg-opacity-100">
        <div className="">
          <IoArrowBack
        ...
        <div className=" grid grid-cols-2">
          ...
          >
            <Avatar className="h-32 w-32 md:w-48 md:h-48  rounded-full overflow-hidden p-1">
              {image ? (
                <AvatarImage
                  src={image}
                  alt="profile"
        ...
        <div className="w-full">
          <Button
            className="h-16 w-full bg-green-400 hover:bg-green-500 transition-all duration-300"
            onClick={saveChanges}
          >
            Save Changes
          </Button>
